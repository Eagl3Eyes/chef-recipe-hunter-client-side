    ...
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-2xl lg:max-w-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <Link to="#" className="text-xs text-rose-600 hover:underline">
            Forget Password?
          </Link>
          <div className="mt-6">
            <button className="btn-primary w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg--500 rounded-md">
              Login
            </button>
          </div>
        </form>
