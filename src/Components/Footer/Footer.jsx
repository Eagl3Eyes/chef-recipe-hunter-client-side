      ...
      <footer className=" bg-indigo-50 mx-auto py-10 px-4 mt-20">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:space-x-12 w-[100%]">
          <div className="mb-4">
            ...
            <p className="text-sm md:text-base lg:text-lg dark:text-gray-400 font-medium mt-4 w-[320px] md:w-[391px]">
              Send us email
            </p>
            <form
            ...
            >
              <input
                ...
                placeholder="Email"
              />
              <button className="btn hover:btn-primary">Subscribe</button>
            </form>
          </div>
        ...
        <p className="text-center mt-5 font-semibold text-base text-gray-400 dark:text-gray-300">
          Copyright © 2023 Rooster Rest. All Rights Reserved.
        </p>
      </footer>
    </div>
  );
